document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayTopRestaurants() {
        ...
        const topRestaurantLinks = [];
        topRestaurants.forEach(card => {
            const originalLink = card.closest('a').getAttribute('href'); // Get the original link from the home page
            const link = document.createElement("a");
            link.href = originalLink; // Use the original link
            ...
            topRestaurantLinks.push(link.href);
        }); }
